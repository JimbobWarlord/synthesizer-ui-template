...
document
  .getElementById("basicRandomBtn")
  .addEventListener("click", basicRandomGen);
...
document
  .getElementById("randomRangeBtn")
  .addEventListener("click", randomRangeGen);
...
function randomRangeGen() {
  ...
  randomRangeResult.innerHTML = remapRange(
    randomNumber,
    0,
    1,
    minRandom,
...
document
  .getElementById("randomIntRangeBtn")
  .addEventListener("click", randomIntRangeGen);
...
document
  .getElementById("randomNonRepIntRangeBtn")
  .addEventListener("click", randomNonRepIntRangeGen);

let randomNonRepIntRangeResult = document.getElementById(
  "randomNonRepIntRangeSpan"
);
let lastRandomNonRepIntRangeResult = document.getElementById(
  "lastRandomNonRepIntRangeSpan"
);
...
function randomNonRepIntRangeGen() {
  ...
  let randomResult = Math.ceil(
    remapRange(randomNumber, 0, 1, minNonRepIntRandom - 1, maxNonRepIntRandom)
  );
...
document
  .getElementById("randomFromListBtn")
  .addEventListener("click", randomListSelect);
...
let listForRandomPick = ["lightsalmon", "tomato", "peachpuff", "olive", "plum"];
...
document
  .getElementById("randomFromListCycleBtn")
  .addEventListener("click", randomListCycleSelect);

let randomFromListCycleResult = document.getElementById(
  "randomFromListCycleSpan"
);
...
function randomListCycleSelect() {
  ...
  let randomSelector = Math.floor(
    workingListForRandomCyclePick.length * randomNumber
  );
...
document
  .getElementById("randomProbBtn")
  .addEventListener("click", randomColourChance);
...
document
  .getElementById("randomFromListProbBtn")
  .addEventListener("click", randomListProbSelect);

let randomFromListProbResult = document.getElementById(
  "randomFromListProbSpan"
);
